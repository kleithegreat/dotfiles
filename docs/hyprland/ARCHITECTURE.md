...
| `rules.conf` | Floating/dialog rules, app-specific geometry, layer rules, a true-fullscreen override for the old XWayland `Minecraft 1.10.2` client so it covers Quickshell's reserved top bar space, and plugin rule glue |

...
| Session wiring | Home Manager keeps the Hyprland GPU env file host-specific, so the laptop and desktop do not share the same user-session GPU assumptions (`home/default.nix:223-229`). |

...
| `config/quickshell/popups/SettingsPopup.qml` | Still mounts the focus-time pane as settings category `6`, after the Notifications pane | `config/quickshell/popups/SettingsPopup.qml:59-68`, `config/quickshell/popups/SettingsPopup.qml:988-1008`, `config/quickshell/popups/SettingsPopup.qml:1046-1048` |

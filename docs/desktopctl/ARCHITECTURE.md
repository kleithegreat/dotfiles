...
- `desktopctl/src/theme/targets/chromium.rs:223-367` adds focused coverage for
  active-profile selection, fallback to `Default`, recursive Chromium prefs
  merging, point-to-CSS-pixel font-size conversion, and per-target font-size
  offsets.

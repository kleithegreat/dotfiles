...
| `home/gtk.nix` | GTK submodule | GTK packages, the repo-packaged upstream-shaped Neuwaita icon theme plus a derived `Neuwaita-KDE` wrapper for Qt/KDE recoloring and Breeze fallback ordering, and small dconf defaults |

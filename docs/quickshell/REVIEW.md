...
- The popup animation and first-paint changes are documented in
  `docs/quickshell/ARCHITECTURE.md`; they still need a real shell smoke test on
  both low-refresh and high-refresh displays.

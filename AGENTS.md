...
lives under `docs/` and is organized by domain. Each domain may have up to three
documents:
...
review for known issues related to your task. If the task touches multiple domains,

...
Item {
    ...
    RowLayout {
        ...
        Components.Icon {
            ...
            color: prevA.containsMouse ? Theme.fg : (mprisRoot.player?.canGoPrevious ? Theme.fg3 : Theme.fg4)
        ...
        Components.Icon {
            source: mprisRoot.player?.isPlaying ? "../icons/player-pause.svg" : "../icons/player-play.svg"
            ...
            MouseArea { id: playA; anchors.fill: parent; cursorShape: Qt.PointingHandCursor; hoverEnabled: true
                onClicked: { if (mprisRoot.player?.canTogglePlaying) mprisRoot.player.isPlaying = !mprisRoot.player.isPlaying; } }
        }
        Components.Icon {
            source: "../icons/player-next.svg"
            color: nextA.containsMouse ? Theme.fg : (mprisRoot.player?.canGoNext ? Theme.fg3 : Theme.fg4)
            iconSize: Theme.fontSizeSmall

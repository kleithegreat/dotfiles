        ...
        Column {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    opacity: 0; x: Theme.notifWidth * 0.4; scale: 0.95
                    ...
                    SequentialAnimation {
                        ...
                        ParallelAnimation {
                            ...
                            NumberAnimation { target: card; property: "x"; from: Theme.notifWidth * 0.4; to: 0; duration: Theme.animNotifIn; easing.type: Easing.OutBack; easing.overshoot: 0.8 }
                            NumberAnimation { target: card; property: "scale"; from: 0.95; to: 1.0; duration: Theme.animNotifIn; easing.type: Easing.OutBack; easing.overshoot: 0.6 }
                        }
                    }
                    ColumnLayout {
                        id: cardC; spacing: 4
    ...
    LazyLoader {
        ...
        PanelWindow {
            ...
            Rectangle { anchors.fill: parent; radius: Theme.osdRadius; color: Theme.bg1; border.width: 1; border.color: Theme.bg3
                ...
                Behavior on scale { NumberAnimation { duration: Theme.animOsdIn; easing.type: Easing.OutBack; easing.overshoot: 1.2 } }
